...
def fetch_current():
  ...
  for i in range(0,1):                          # ****** MAIN FOR-LOOP *******
      ...
      url = f"https://api.weatherbit.io/v2.0/history/hourly?lat=26.96&lon=70.87&start_date={past_day}&end_date={current_date}&tz=local&key={API_KEY}"
...
# Historical DATA
df_prev = pd.read_csv("/home/ec2-user/files/Jaisalmer.csv",index_col=[0])
...
# Future Fetch
url = f"https://api.weatherbit.io/v2.0/forecast/hourly?lat=26.96&lon=70.87&key={API_KEY}&hours=120"
...
df_future.to_csv("Jaisalmer_future.csv")
...
df_jsons = df_jsons.T
df_jsons.to_json('Jaisalmer_Wind_48hrs.json', orient='records')
...
double_df.to_json('Jaisalmer_Features_2_days.json', orient='records')
...
XGB_result.to_csv("Jaisalmer_Predictions_Ady.csv")
XGB_result=XGB_result.T
XGB_result.to_json('Jaisalmer_Predictions.json', orient='records')
